...
public class S3KDSStreaming {
    private static final String region = "us-east-1";
    private static final String inputStreamName = "kinesis-kda-stream";
    private static final String s3SinkPath = "s3a://aws-gcr-bigdataday/output";
